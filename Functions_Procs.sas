PROC IMPORT OUT= WORK.market_asset
            DATAFILE= "C:\Users\Ming Lei\Documents\SAS Programs and Analytics\Datasets\Market_data_two.csv"
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2;
RUN;
...
PROC IMPORT OUT= WORK.market_campaign
            DATAFILE= "C:\Users\Ming Lei\Documents\SAS Programs and Analytics\Datasets\Market_campaign.csv"
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2;
RUN;
...
libname mydata 'C:\Users\Ming Lei\Documents\SAS Programs and Analytics\Datasets';
PROC IMPORT OUT= MYDATA.bill
            DATAFILE= "C:\Users\Ming Lei\Documents\SAS Programs and Analytics\Datasets\Telco_Bill_data.csv"
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2;
RUN;
...
PROC IMPORT OUT= market_asset
            DATAFILE= "C:\Users\Ming Lei\Documents\SAS Programs and Analytics\Datasets\Market_asset.csv"
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2;
RUN;
...
PROC IMPORT OUT= WORK.complaints
            DATAFILE= "C:\Users\Ming Lei\Documents\SAS Programs and Analytics\Datasets\Telco_complaints_data.csv"
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2;
RUN;
